...
<html>
    ...
    <div class="container-fluid col-11 d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li ><a class="nav-link scrollto active" href="taHome.jsp">Home</a></li>
                                    ...
                                    <li><a class="nav-link scrollto " href="fileRequest.jsp">File Requests</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="herotaho" class="d-flex align-items-center">
    <div class="container">
      ...
      <h2 style="color: black">Using Advanced Encryption Standard for E-Healthcare Cloud</h2>
        ...
        <section class="our-services" id="services">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <img src="img/details.jpg" width="1100" height="550">
                    </div>
                </div>
            </div>
        </section>
