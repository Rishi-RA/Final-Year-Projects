...
<html>
  ...
  <!-- Favicons -->
    ...
    %>
    <%
        if (request.getParameter("Name_Exists") != null) {
    %>
    <script>alert('Name Already Existed');</script>
    <%            }
    %>
    <body>
  ...
  <section id="hero1" class="d-flex align-items-center ">
    <div class="container">
      ...
      <a href="#log" class="btn-get-started scrollto" style="text-decoration: none;">Go To Login</a>
    </div>
  </section><!-- End Hero -->
        ...
        <section class="our-services" id="services">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-lg-6">
                            <img src="img/login5.jpg" width="450" height="350">
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
