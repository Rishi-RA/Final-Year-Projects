...
<header id="header" class="fixed-top">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li ><a class="nav-link scrollto " href="doctorHome.jsp">Home</a></li>
                                    <li><a class="nav-link scrollto active" href="getSearchToken.jsp">Get Search Token</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="tokensearch" class="d-flex align-items-center">
    <div class="container">
     ...
     <a href="#get" class="btn-get-started scrollto g-6">Request Token</a>
