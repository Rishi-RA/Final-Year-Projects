...
<html>
    ...
    <div class="container-fluid col-11 d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li ><a class="nav-link scrollto " href="taHome.jsp">Home</a></li>
                                    <li><a class="nav-link scrollto  " href="patientDetails.jsp">patient Details</a></li>
                                    <li><a class="nav-link scrollto " href="doctorDetails.jsp">Doctor Details</a></li>
                                    <li><a class="nav-link scrollto active" href="fileRequest.jsp">File Requests</a></li>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="requestfile" class="d-flex align-items-center">
    <div class="container">
      ...
      <a href="#filereq" class="btn-get-started scrollto g-6" style="text-decoration:none;">Go to approve</a>
    </div>
  </section><!-- End Hero -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h1 id="filereq">File Requests</h1>
                        </div>
                    </div> 
                </div> 
                <div class="row">
