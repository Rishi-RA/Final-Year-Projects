...
<html>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li ><a class="nav-link scrollto" href="index.jsp">Home</a></li>
                                    ...
                                    <li><a class="nav-link scrollto active" href="cloudLogin.jsp">Cloud</a></li>
            </ul>
  ...
  <!-- ======= Hero Section ======= -->
  <section id="cloudlogin" class="d-flex align-items-center">
    <div class="container">
      ...
      <a href="#clouds" class="btn-get-started scrollto g-6" style="text-decoration: none;">Go to login</a>
    </div>
  </section><!-- End Hero -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section-heading">
                            <h1 id="clouds">Cloud Server Login</h1>
                        </div>
                    </div> 
                </div> 
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-lg-6">
                            <img src="img/cloud.jpg" width="450" height="350">
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
